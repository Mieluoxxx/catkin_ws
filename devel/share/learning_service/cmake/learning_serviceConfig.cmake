...
if("TRUE" STREQUAL "TRUE")
  set(learning_service_SOURCE_PREFIX /home/eaibot/catkin_ws/src/learning_service)
  set(learning_service_DEVEL_PREFIX /home/eaibot/catkin_ws/devel)
  ...
  set(learning_service_INSTALL_PREFIX /home/eaibot/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'learning_service' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/eaibot/catkin_ws/src/learning_service/${idir}'.  ${_report}")
    endif()
    _list_append_unique(learning_service_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "learning_service")
